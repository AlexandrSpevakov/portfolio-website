      ...
      >
        ...
        <section className="mt-20 grid grid-cols-3 gap-x-10">
          ...
          >
            ...
            <span className="mt-3 block text-lg">Let&apos;s get in touch</span>
          </a>
          ...
          >
            ...
            <span className="mt-3 block text-lg">Let&apos;s connect</span>
          </a>
          ...
          >
            ...
            <span className="mt-3 block text-lg">Checkout my repos</span>
          </a>
        </section>
      </section>
    </section>
